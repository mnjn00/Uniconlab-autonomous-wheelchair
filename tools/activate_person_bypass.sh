...
PERSON_BYPASS_OBSERVE_FORWARD_M="${PERSON_BYPASS_OBSERVE_FORWARD_M:-10.0}"
...
setsid nohup env $SINGLE_THREAD_ENV \
  ...
  _person_bypass_observation_forward_m:="$PERSON_BYPASS_OBSERVE_FORWARD_M" \
...
==============================================================
 STATIC-THREAT TRAJECTORY BYPASS READY - PAUSED
  ...
  passed-side behavior  : release speed and steering directly to normal DWA
