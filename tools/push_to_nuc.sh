...
for f in routes/20260816_route_v9_clearance_waypoints.json \
         routes/20260816_route_v9_clearance_safety_band.json \
...
python3 -c "
import json
w = json.load(open('routes/20260816_route_v9_clearance_waypoints.json'))
b = json.load(open('routes/20260816_route_v9_clearance_safety_band.json'))
